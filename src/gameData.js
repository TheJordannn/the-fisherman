...
const BADGES = window.BADGES = {
    ...
    catches_10: { id: "catches_10", name: "Master Angler", desc: "Land 10 successful catches.", earned: false },
    catches_25: { id: "catches_25", name: "Grandmaster Fisher", desc: "Land 25 successful catches.", earned: false },
    ...
    escapes_15: { id: "escapes_15", name: "Slippery Legend", desc: "Have 15 animals escape or snap your line.", earned: false },
    exhausted_3: { id: "exhausted_3", name: "Merciless Reeler", desc: "Overwork 3 creatures to exhaustion.", earned: false },
    exhausted_8: { id: "exhausted_8", name: "Exhaustion Legend", desc: "Overwork 8 creatures to exhaustion.", earned: false },
    photos_5: { id: "photos_5", name: "Shutterbug", desc: "Snap 5 trophy photos of your catches.", earned: false },
    money_1000: { id: "money_1000", name: "First Grand", desc: "Amass a total of $1,000 cash earned.", earned: false },
    money_5000: { id: "money_5000", name: "Elite Merchant", desc: "Amass a total of $5,000 cash earned.", earned: false },
...
const CREATURE_SVGS = window.CREATURE_SVGS = {
    ...
    girl: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-none"><path fill="#2c1e21" d="M30,30 C30,10 70,10 70,30 C70,35 65,40 60,40 C55,40 45,40 40,40 C35,40 30,35 30,30 Z" /><path fill="#2c1e21" d="M65,22 C78,10 82,25 74,32 C70,35 66,30 65,22 Z" /><path fill="#b91c1c" d="M60,25 C64,22 66,28 62,30 Z" /><circle fill="#b91c1c" cx="62" cy="26" r="3" /><path fill="#ffebd6" d="M38,30 C38,20 62,20 62,30 C62,38 58,45 50,47 C42,45 38,38 38,30 Z" /><ellipse fill="#b91c1c" cx="44" cy="30" rx="2" ry="3.5" /><ellipse fill="#b91c1c" cx="56" cy="30" rx="2" ry="3.5" /><circle fill="#ffffff" cx="44.5" cy="29" r="0.7" /><circle fill="#ffffff" cx="56.5" cy="29" r="0.7" /><ellipse fill="rgba(244,114,182,0.5)" cx="43" cy="33" rx="2" ry="1" /><ellipse fill="rgba(244,114,182,0.5)" cx="57" cy="33" rx="2" ry="1" /><path d="M47,36 Q50,38 53,36" stroke="#b91c1c" stroke-width="0.8" stroke-linecap="round" /><path fill="#2c1e21" d="M38,25 Q50,22 62,25 L61,28 Q50,25 39,28 Z" /><path fill="#2c1e21" d="M38,26 Q42,34 40,38 L36,30 Z" /><path fill="#2c1e21" d="M62,26 Q58,34 60,38 L64,30 Z" /><path fill="#2c1e21" d="M48,24 Q50,33 46,31 Z" /><rect fill="#ffebd6" x="47" y="44" width="6" height="5" /><path fill="#1c1b1c" d="M35,48 L65,48 L70,80 L30,80 Z" /><path fill="#ffffff" d="M38,48 L62,48 L50,56 Z" /><path fill="#1c1b1c" d="M46,48 L54,48 L50,52 Z" /><circle fill="#e11d48" cx="50" cy="53" r="1.5" /><path fill="#e11d48" d="M47,51 L53,55 M53,51 L47,55" stroke="#e11d48" stroke-width="1.2" stroke-linecap="round" /><path fill="#1c1b1c" d="M35,48 Q28,62 38,62" stroke="#1c1b1c" stroke-width="4" stroke-linecap="round" fill="none" /><path fill="#1c1b1c" d="M65,48 Q72,62 62,62" stroke="#1c1b1c" stroke-width="4" stroke-linecap="round" fill="none" /><ellipse fill="#ffffff" cx="37" cy="62" rx="2.5" ry="1.5" /><ellipse fill="#ffffff" cx="63" cy="62" rx="2.5" ry="1.5" /><circle fill="#ffebd6" cx="38" cy="64" r="2" /><circle fill="#ffebd6" cx="62" cy="64" r="2" /><rect fill="#ffebd6" x="42" y="80" width="5" height="15" /><rect fill="#ffebd6" x="53" y="80" width="5" height="15" /><rect fill="#1c1b1c" x="42" y="85" width="5" height="10" /><rect fill="#1c1b1c" x="53" y="85" width="5" height="10" /><ellipse fill="#78350f" cx="44.5" cy="95" rx="3" ry="1.8" /><ellipse fill="#78350f" cx="55.5" cy="95" rx="3" ry="1.8" /></svg>`,
