...
const CREATURE_SVGS = window.CREATURE_SVGS = {
    jellyfish: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><path d="M20,50 C20,20 80,20 80,50 L75,55 C75,55 70,50 65,55 C60,50 55,55 50,50 C45,55 40,50 35,55 L20,50 Z" /><path d="M30,55 Q25,80 35,95 M42,52 Q45,85 40,95 M50,50 Q55,80 50,95 M58,52 Q55,85 60,95 M70,55 Q75,80 65,95" stroke="currentColor" stroke-width="4" fill="none" /></svg>`,
    squid: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><path d="M50,15 L30,45 L40,55 L35,90 M50,15 L70,45 L60,55 L65,90 M45,55 L45,95 M55,55 L55,95 M50,55 L50,95" stroke="currentColor" stroke-width="4" fill="none"/><path d="M50,10 L30,40 L70,40 Z"/></svg>`,
    octopus: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><circle cx="50" cy="40" r="23"/><path d="M35,60 Q20,70 15,90 M42,65 Q35,85 30,95 M50,65 Q50,90 50,98 M58,65 Q65,85 70,95 M65,60 Q80,70 85,90 M30,50 Q10,55 5,75 M70,50 Q90,55 95,75" stroke="currentColor" stroke-width="5" fill="none" stroke-linecap="round"/></svg>`,
    turtle: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><circle cx="50" cy="50" r="23" /><circle cx="50" cy="22" r="9"/><path d="M30,40 C15,35 15,25 25,35 M70,40 C85,35 85,25 75,35 M32,65 C18,75 22,80 30,72 M68,65 C82,75 78,80 70,72" stroke="currentColor" stroke-width="6" fill="none" stroke-linecap="round"/></svg>`,
    ray: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><path d="M50,15 L20,50 L50,65 L80,50 Z" /><path d="M50,65 Q50,85 45,95" stroke="currentColor" stroke-width="4" fill="none"/></svg>`,
    crab: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><ellipse cx="50" cy="55" rx="25" ry="18" /><path d="M30,45 Q20,25 35,20 M70,45 Q80,25 65,20" stroke="currentColor" stroke-width="5" fill="none" stroke-linecap="round" /><path d="M25,55 Q10,60 5,70 M25,60 Q10,70 10,80 M75,55 Q90,60 95,70 M75,60 Q90,70 90,80" stroke="currentColor" stroke-width="4" fill="none"/></svg>`,
    eel: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-none" stroke="currentColor" stroke-width="8" stroke-linecap="round"><path d="M15,50 Q30,30 45,50 T75,50 T90,45" /></svg>`,
    shark: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><path d="M15,55 Q50,35 85,50 L90,35 L95,65 L85,55 Q50,75 15,55" /><path d="M50,42 L55,20 L65,30 Z" /></svg>`,
    seahorse: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><path d="M55,20 C45,15 40,25 45,35 C42,45 55,50 48,65 C40,75 52,85 45,95" stroke="currentColor" stroke-width="6" fill="none" stroke-linecap="round"/><path d="M45,25 L30,22 L30,28 Z"/><path d="M48,32 C58,35 55,48 45,45" stroke="currentColor" stroke-width="4" fill="none"/></svg>`,
    anglerfish: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><circle cx="45" cy="55" r="23"/><path d="M20,55 L5,45 L5,65 Z"/><path d="M50,35 Q65,15 75,30" stroke="currentColor" stroke-width="3" fill="none"/><circle cx="75" cy="30" r="5" fill="white"/><path d="M55,55 L65,52 M55,60 L65,60" stroke="currentColor" stroke-width="3"/></svg>`,
    bird: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-none" stroke="currentColor" stroke-width="6" stroke-linecap="round"><path d="M20,40 Q40,15 50,40 T80,40" /><path d="M45,40 L45,55 M52,40 L52,55" stroke="currentColor" stroke-width="3"/></svg>`,
    dolphin: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><path d="M10,50 C25,30 55,18 80,32 C95,40 92,52 82,56 C68,60 52,52 38,58 C25,62 12,54 10,50 Z" /><path d="M75,35 C80,22 75,15 68,12 C72,20 72,28 73,34 Z" /><path d="M45,48 C52,62 48,70 42,75 C45,66 43,58 41,52 Z" /><path d="M15,48 C5,45 2,38 0,32 C4,38 10,42 12,45 Z" /></svg>`,
    fish: `<svg viewBox="0 0 100 100" class="w-10 h-10 fill-current"><ellipse cx="50" cy="50" rx="35" ry="20" /><path d="M15,50 L0,35 L0,65 Z" /></svg>`
};
...
const storeInventory = window.storeInventory = {
    ...
    supplies: [
        { id: 'hook', name: 'Replacement Hook', desc: '$10 each', price: 10, type: 'supply' }
    ]
};
